...
const typeDefs = gql`
	...
	type Mutation {
		...
		addEntry(date: String!, coin: String!, slug: String!, amount: Float!): Entry
		editEntry(id: ID!, date: String!, coin: String!, slug: String!, amount: Float!): Entry
		addStory(title: String!, imageUrl: String!, description: String!, category: String!, text: String!): Story
